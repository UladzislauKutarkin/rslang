...
import person_1 from "../../../assets/img/person_ya.jpg";
import img_Header_promo from "../../../assets/img/english_promo_header.jpg";
      ...
      <main>
        <div className="relative pt-80 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage: `url(${img_Header_promo})`,
            }}
          ></div>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    <h5 className="text-xl font-bold">Александр Якубовский</h5>
